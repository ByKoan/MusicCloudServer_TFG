...
>`Project version: 2.3.3`  (This value will be updated on every funcionality change in the project)

> ***About this version: In the last version, Added ban and update rol fields in inline field in the admin panel. Features/Bugs to add/fix: need to add funcionality to remove playlists***
